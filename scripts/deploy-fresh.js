...
async function main() {
  console.log("Deploying LiskHealth AI with fresh address for Hackathon...");

  // Get the contract factory
  const HealthContractV2 = await ethers.getContractFactory("HealthContractV2");
